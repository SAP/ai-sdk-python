...
class PredictionResult(BaseModel):
    ...
    confidence: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="The confidence of the prediction (null for regression predictions).")
    confidence_interval: Optional[Annotated[List[Any], Field(min_length=2, max_length=2)]] = Field(default=None, description="Lower and upper bounds of the prediction confidence interval (null for classification predictions).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["prediction", "confidence", "confidence_interval"]
