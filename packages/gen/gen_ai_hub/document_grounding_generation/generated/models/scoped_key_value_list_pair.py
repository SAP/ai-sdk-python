...
class ScopedKeyValueListPair(BaseModel):
    """
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['collection', 'document', 'chunk']):
            raise ValueError("must be one of enum values ('collection', 'document', 'chunk')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScopedKeyValueListPair from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScopedKeyValueListPair from a dict"""
        if obj is None:
            return None
