...
class KeyWordRetrievalScoringConfiguration(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeyWordRetrievalScoringConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if extract_key_words_from_query (nullable) is None
        # and model_fields_set contains the field
        if self.extract_key_words_from_query is None and "extract_key_words_from_query" in self.model_fields_set:
            _dict['extractKeyWordsFromQuery'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeyWordRetrievalScoringConfiguration from a dict"""
        if obj is None:
            return None
