...
class RetrievalVectorSearchFilter(BaseModel):
    """
    ...
    data_repository_type: Optional[DataRepositoryType] = Field(default=None, serialization_alias="dataRepositoryType")
    ...
    scoring_configuration: Optional[VectorScoringConfiguration] = Field(default=None, serialization_alias="scoringConfiguration")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrievalVectorSearchFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrievalVectorSearchFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scoring_configuration": VectorScoringConfiguration.from_dict(obj["scoringConfiguration"]) if obj.get("scoringConfiguration") is not None else None
        })
