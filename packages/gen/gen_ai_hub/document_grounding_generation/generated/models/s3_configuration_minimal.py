...
class S3ConfigurationMinimal(BaseModel):
    """
    S3ConfigurationMinimal
    """ # noqa: E501
    s3: ServiceNowConfigurationMinimalServiceNow
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of S3ConfigurationMinimal from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of S3ConfigurationMinimal from a dict"""
        if obj is None:
            return None
