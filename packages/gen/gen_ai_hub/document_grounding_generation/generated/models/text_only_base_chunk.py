...
class TextOnlyBaseChunk(BaseModel):
    ...
    id: UUID = Field(description="Unique identifier of a chuk.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TextOnlyBaseChunk from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TextOnlyBaseChunk from a dict"""
        if obj is None:
            return None
