...
if TYPE_CHECKING:
    ...
    from .vector.vector_request_builder import VectorRequestBuilder

class DocumentGroundingClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new DocumentGroundingClient and sets the default values.
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "/lm/document-grounding"
    ...
    @property
    def vector(self) -> VectorRequestBuilder:
        """
        The vector property
        """
        from .vector.vector_request_builder import VectorRequestBuilder

        return VectorRequestBuilder(self.request_adapter, self.path_parameters)
