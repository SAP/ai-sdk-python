...
class DocumentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /pipelines/{pipelineId}/executions/{executionId}/documents
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/pipelines/{pipelineId}/executions/{executionId}/documents{?%24count*,%24skip*,%24top*}", path_parameters)
    
    def by_document_id(self,document_id: str) -> WithDocumentItemRequestBuilder:
        """
        Gets an item from the gen_ai_hub.document_grounding_generation_kiota.generated.pipelines.item.executions.item.documents.item collection
