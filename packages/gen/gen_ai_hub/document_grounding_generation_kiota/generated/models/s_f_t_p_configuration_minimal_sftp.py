...
@dataclass
class SFTPConfigurationMinimal_sftp(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SFTPConfigurationMinimal_sftp:
        """
        ...
        return SFTPConfigurationMinimal_sftp()
