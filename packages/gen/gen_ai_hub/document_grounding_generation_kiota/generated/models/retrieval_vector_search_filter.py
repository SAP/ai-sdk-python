...
if TYPE_CHECKING:
    ...
    from .retrieval_vector_search_filter_filter import RetrievalVectorSearchFilter_filter
    from .vector_scoring_configuration import VectorScoringConfiguration

@dataclass
class RetrievalVectorSearchFilter(AdditionalDataHolder, Parsable):
    ...
    filter: Optional[RetrievalVectorSearchFilter_filter] = None
    # Identifier of this RetrievalSearchFilter - unique per request.
    id: Optional[str] = None
    # Destination Name of remote instance.
    remote_name: Optional[str] = None
    # The scoringConfiguration property
    scoring_configuration: Optional[VectorScoringConfiguration] = None
    # The searchConfiguration property
    search_configuration: Optional[RetrievalSearchConfiguration] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrievalVectorSearchFilter:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RetrievalVectorSearchFilter
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RetrievalVectorSearchFilter()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "filter": lambda n : setattr(self, 'filter', n.get_object_value(RetrievalVectorSearchFilter_filter)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "remoteName": lambda n : setattr(self, 'remote_name', n.get_str_value()),
            "scoringConfiguration": lambda n : setattr(self, 'scoring_configuration', n.get_object_value(VectorScoringConfiguration)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("scoringConfiguration", self.scoring_configuration)
