...
@dataclass
class S3Configuration_s3(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> S3Configuration_s3:
        """
