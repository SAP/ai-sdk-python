...
@dataclass
class RetrievalSearchInput_postProcessing_inputs(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrievalSearchInput_postProcessing_inputs:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RetrievalSearchInput_postProcessing_inputs
        """
        ...
        try:
            ...
            mapping_value = None
        result = RetrievalSearchInput_postProcessing_inputs()
