...
@dataclass
class ServiceNowConfigurationMinimal_serviceNow(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ServiceNowConfigurationMinimal_serviceNow:
        """
        ...
        return ServiceNowConfigurationMinimal_serviceNow()
