...
@dataclass
class BinaryBooleanFilter_right(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BinaryBooleanFilter_right:
        """
        ...
        result = BinaryBooleanFilter_right()
        from .binary_boolean_filter import BinaryBooleanFilter
