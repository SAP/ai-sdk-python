...
@dataclass
class MergeStrategyScoreReuse(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MergeStrategyScoreReuse:
        """
        ...
        return MergeStrategyScoreReuse()
