...
@dataclass
class BinaryBooleanFilter_left(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BinaryBooleanFilter_left:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BinaryBooleanFilter_left
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = BinaryBooleanFilter_left()
        from .binary_boolean_filter import BinaryBooleanFilter
