...
@dataclass
class RetrievalBinaryBooleanFilter_right(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrievalBinaryBooleanFilter_right:
        """
        ...
        result = RetrievalBinaryBooleanFilter_right()
        from .retrieval_binary_boolean_filter import RetrievalBinaryBooleanFilter
