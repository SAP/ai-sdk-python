...
@dataclass
class GoogleDriveConfigurationStruct(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GoogleDriveConfigurationStruct:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GoogleDriveConfigurationStruct
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return GoogleDriveConfigurationStruct()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "googleDrive": lambda n : setattr(self, 'google_drive', n.get_object_value(GoogleDriveConfig)),
