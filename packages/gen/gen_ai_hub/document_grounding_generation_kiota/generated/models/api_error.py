...
if TYPE_CHECKING:
    from .details_error_response import DetailsErrorResponse

@dataclass
class ApiError(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApiError:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "details": lambda n : setattr(self, 'details', n.get_collection_of_object_values(DetailsErrorResponse)),
