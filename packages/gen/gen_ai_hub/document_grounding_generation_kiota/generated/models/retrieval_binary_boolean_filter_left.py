...
@dataclass
class RetrievalBinaryBooleanFilter_left(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrievalBinaryBooleanFilter_left:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RetrievalBinaryBooleanFilter_left
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        result = RetrievalBinaryBooleanFilter_left()
        from .retrieval_binary_boolean_filter import RetrievalBinaryBooleanFilter
