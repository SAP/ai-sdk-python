...
try:
    ...
    from httpx import Response, AsyncByteStream  # type: ignore[no-redef]
...
OPENAI_RESPONSES_RESPONSE = {
    "id": "resp_0c53f34ef0cff6e20069d37bdfdf608195a0383bfbd1bcb96a",
    "created_at": 1775467487.0,
    "error": None,
    ...
    "output": [
        ...
        {
            "id": "msg_0c53f34ef0cff6e20069d37be2ee3c8195bdbc665c51719627",
            "content": [
                {
                    "annotations": [],
                    "text": "this is a test",
...
OPENAI_RESPONSES_RESPONSE_PARSE = {
    "id": "resp_08f37e5066d98b600069d3834afc948190979ba52db1e5713b",
    "created_at": 1775469387.0,
    "error": None,
    "incomplete_details": None,
    "instructions": None,
    "metadata": {},
    ...
    "output": [
        {
            "id": "rs_08f37e5066d98b600069d3834b94348190b29a3bd6ddd744f8",
            "summary": [],
            "type": "reasoning",
            "content": None,
            "encrypted_content": None,
        ...
        {
            "id": "msg_08f37e5066d98b600069d38366ace88190b550ce4331f8c03f",
            "content": [
                {
                    "annotations": [],
    ...
    "text": {
        "format": {
            ...
            "schema_": {
                ...
                "description": "A simple Pydantic model for testing structured outputs with OpenAI.",
                "properties": {
                    "first_name": {
                        "title": "First Name",
                        "type": "string",
