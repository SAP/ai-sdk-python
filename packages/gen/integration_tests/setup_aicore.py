...
def _setup_models(client: AICoreV2Client, models: List[tuple], max_wait_seconds=1200):
...
@lru_cache
def setup_bedrock_models(client: AICoreV2Client, max_wait_seconds=1200):
...
@lru_cache
def setup_standard_models(client: AICoreV2Client, max_wait_seconds=1200):
...
@lru_cache
def setup_aicore_instance(client: AICoreV2Client, max_wait_seconds=1200):
