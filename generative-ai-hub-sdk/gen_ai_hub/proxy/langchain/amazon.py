...
MODEL_NAME_TO_MODEL_ID_MAP = {
    "amazon--titan-embed-image": "amazon.titan-embed-image-v1",
    ...
    "anthropic--claude-4.5-sonnet": "anthropic.claude-sonnet-4-5-20250929-v1:0",
    "anthropic--claude-4.5-haiku": "anthropic.claude-haiku-4-5-20251001-v1:0",
