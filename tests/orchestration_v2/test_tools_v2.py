...
from gen_ai_hub.orchestration_v2.models.tools import FunctionTool, function_tool
...
class TestFunctionTool(unittest.TestCase):
    def test_from_function_basic(self):
        ...
        self.assertEqual(tool.function.parameters["properties"]["a"]["type"], "number")
        self.assertEqual(tool.function.parameters["properties"]["b"]["type"], "number")
    ...
    def test_from_function_optional(self):
        ...
        self.assertEqual(tool.function.name, "greet")
        self.assertIn("title", tool.function.parameters["properties"])
        self.assertNotIn("title", tool.function.parameters["required"])
        self.assertTrue(tool.function.parameters["properties"]["title"]["nullable"])
    ...
    def test_decorator(self):
        ...
        self.assertEqual(echo.function.name, "echo")
    ...
    def test_description_precedence(self):
        ...
        self.assertEqual(tool1.function.description, "This is the docstring.")
        self.assertIn("description", tool1.model_dump()["function"])
        ...
        self.assertEqual(tool2.function.description, "Explicit description.")
        self.assertIn("description", tool2.model_dump()["function"])
        self.assertEqual(tool2.model_dump()["function"]["description"], "Explicit description.")
        ...
        tool3 = no_desc
        self.assertIsNone(tool3.function.description)
        self.assertNotIn("description", tool3.model_dump()["function"])
